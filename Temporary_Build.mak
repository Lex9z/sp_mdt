...
OBJFILES = output\MultiPortFlashDownloadProject.obj \
    ...
    output\BackupConfig.obj output\MD5.obj output\IdentityVerify.obj \
    output\Form_PasswordSetting.obj output\tinystr.obj output\tinyxml.obj \
    output\tinyxmlerror.obj output\tinyxmlparser.obj \
    output\EfuseXMLSetting.obj output\MetaProcess.obj
...
RESDEPEN = $(RESFILES) MultiPortFlashDownloadTool.dfm Form\form_About.dfm \
    ...
    Form\formChecksumProgress.dfm Form\IdentityVerify.dfm \
    Form\Form_PasswordSetting.dfm
LIBFILES = "C:\Program Files\Borland\CBuilder6\Lib\Psdk\shell32.lib" Lib\eboot.lib \
    Lib\FlashToolLib.lib Lib\SLA_Challenge.lib Lib\des.lib \
    Meta\Lib\SP_META_Wrapper.lib Meta\Lib\SPBootMode.lib Meta\Lib\SPMETA_DLL.lib
IDLFILES = 
IDLGENFILES = 
...
USERDEFINES = $(USERDEFINES);NO_WIN32_LEAN_AND_MEAN;_DEBUG
SYSDEFINES = NO_STRICT;_NO_VCL
INCLUDEPATH = Meta;TinyXml\src;Efuse;Brom;Eboot;FirmwareUpgrade;Form;Common;Headers;INIFileHandle;"C:\Program Files\Borland\CBuilder6\Projects";$(BCB)\include;$(BCB)\include\vcl;Meta\inc
LIBPATH = Meta;TinyXml\src;Efuse;FirmwareUpgrade;"Comm\USB COM";"META App";GPS;Comm\PCMCIA;FailReason;Form;Common;INIFileHandle;"C:\Program Files\Borland\CBuilder6\Projects";"C:\Multiport download source\Multiport_DL source v2.4.1004_VCL";$(BCB)\Projects\Lib;freqz;firls;$(BCB)\lib\obj;$(BCB)\lib;$(BCB)\lib\Psdk;Meta\Lib
WARNINGS= -w-par
PATHCPP = .;INIFileHandle;INIFileHandle;Common;Form;Common;Form;Form;Form;FirmwareUpgrade;FirmwareUpgrade;INIFileHandle;Efuse;Efuse;Efuse;Form;Form;Form;Form;TinyXml\src;TinyXml\src;TinyXml\src;TinyXml\src;Efuse;Meta
PATHASM = .;
PATHPAS = .;
PATHRC = .;
PATHOBJ = .;$(LIBPATH)
...
CFLAG1 = -Od -H=$(BCB)\lib\vcl60.csm -Vx -Ve -RT- -X- -r- -a8 -b -k -y -v -vi- -tWD \
    -tWM- -c
IDLCFLAGS = -ITinyXml\src -IEfuse -IBrom -IEboot -IFirmwareUpgrade -IForm -ICommon \
    -IHeaders -IINIFileHandle -I"C:\Program Files\Borland\CBuilder6\Projects" \
    -I$(BCB)\include -I$(BCB)\include\vcl -src_suffix cpp -D$(USERDEFINES) \
