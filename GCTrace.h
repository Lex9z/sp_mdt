...
#define		DEFAULT_NWVT_LOG_PATH	"C:\\SP_MDT.log"
...
public:
	...
	void dump_binary_by_hex(const unsigned char * byte,  unsigned long len);

	void tarce(const char *pText, ...);

    void base_tarce(const char *pText, ...);
